...
import static cn.hein.common.constant.system.SystemConstant.OS_NAME_KEY;
import static cn.hein.common.constant.system.SystemConstant.OS_WIN_PREFIX;
import static cn.hein.common.toolkit.ClassUtil.simpleClassName;
...
public class HashedWheelTimer implements Timer {
    ...
    private static void reportTooManyInstances() {
        ...
        log.error("You are creating too many {} instances. {} is a shared resource that must be reused across the JVM, so that only a few instances are created.", resourceType, resourceType);
    }
